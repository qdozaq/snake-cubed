...
const snakeAnimation = (n: number) => {
  ...
  ` : css`
    #_${n} {
      animation: ${snakeKeyframes(n - 1)} ${ANIMATION_LENGTH * 2}s 1s infinite linear;
    }
  `
}
...
const SVG = styled.svg`
  ...
  #left {
    animation: ${snakeKeyframes(4)} ${ANIMATION_LENGTH * 2}s -3s infinite linear;
  }
...
export default () => <SVG xmlns="http://www.w3.org/2000/svg" viewBox="0 0 189.94 86">
  <g id="cubes">
    <g id="_5" data-name="5">
  ...
  <g id="left">
    <text transform="translate(100.25 33.04)" font-size="29" >LEFT</text>
  </g>
  <g id="right">
    <text transform="translate(100.25 72.04)" font-size="29" >RIGHT</text>
  </g>
</SVG>